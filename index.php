...
<head>
    ...
    <link rel="stylesheet" href="./css/card.css"> <!-- Kendi stil dosyanız -->
...
<body>
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-9"> <!-- Blog içeriklerinin genişliği burada 9 olarak ayarlandı -->
                <?php foreach ($blogs as $blog): ?>
                    <div class="card mb-4 shadow border-0">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <?php if ($blog['image']): ?>
                                    <img src="./uploads/<?php echo htmlspecialchars($blog['image']); ?>" class="img-fluid rounded-start" alt="">
                                <?php endif; ?>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title text-primary font-weight-bold"><?php echo htmlspecialchars($blog['title']); ?></h5>
                                    <p class="card-text text-muted"><?php echo htmlspecialchars(substr($blog['content'], 0, 100)) . '...'; ?></p>
                                    <a href="blog_detail.php?id=<?php echo $blog['id']; ?>" class="btn btn-success">Devamını Oku</a>
                                </div>
                            </div>
                        </div>
                    </div>
